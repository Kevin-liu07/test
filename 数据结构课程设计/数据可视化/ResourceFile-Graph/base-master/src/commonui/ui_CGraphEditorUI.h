...
public:
    ...
    void setupUi(QWidget *CLinklistEditorUI)
    {
        ...
        pushButton->setGeometry(QRect(50, 40, 101, 28));
        pushButton_2 = new QPushButton(CLinklistEditorUI);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setGeometry(QRect(50, 80, 101, 28));
        pushButton_3 = new QPushButton(CLinklistEditorUI);
        pushButton_3->setObjectName(QString::fromUtf8("pushButton_3"));
        pushButton_3->setGeometry(QRect(50, 160, 101, 28));
        pushButton_4 = new QPushButton(CLinklistEditorUI);
        pushButton_4->setObjectName(QString::fromUtf8("pushButton_4"));
        pushButton_4->setGeometry(QRect(50, 120, 101, 28));
